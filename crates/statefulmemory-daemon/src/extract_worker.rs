...
use statefulmemory_extract::{ClaudeCliExtractor, Turn};
use statefulmemory_storage::write::{NewFact, WriteRequest};
...
impl ExtractWorkerPool {
    ...
    pub fn spawn(
        ...
        for i in 0..n {
            ...
            thread::Builder::new()
                .name(format!("statefulmemory-extract-{i}"))
...
async fn process(
    ...
    let r = reply_rx
        .await
        .map_err(|e| anyhow::anyhow!("recv InsertFacts reply: {e}"))?;
