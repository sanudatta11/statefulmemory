...
pub const HOOK_START: &str = "# >>> statefulmemory >>>";
pub const HOOK_END: &str = "# <<< statefulmemory <<<";
...
fn crate_is_repo(dir: &Path) -> bool {
    statefulmemory_core::git::is_repo(dir)
}

/// Install statefulmemory blocks into post-commit / post-merge / post-checkout.
...
/// Remove statefulmemory marker blocks from the three hooks. Leaves other content.
