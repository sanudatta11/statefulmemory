...
const NAMES: &[&str] = &[
    ...
    "Leo", "Mia", "Ned", "Olive", "Pete", "Quinn", "Rose", "Sam", "Tina",
];
const PROPS: &[(&str, &[&str])] = &[
    (
        "favourite colour",
        &[
            "red", "blue", "green", "yellow", "purple", "orange", "teal", "pink", "white", "black",
        ],
    ),
    (
        "favourite food",
    ...
    (
        "hobby",
        &[
            "hiking", "painting", "chess", "coding", "cycling", "cooking", "gaming", "reading",
            "yoga", "knitting",
        ],
    ),
    (
        "home city",
        &[
            "London", "Tokyo", "Paris", "New York", "Sydney", "Cairo", "Lagos", "Seoul", "Mumbai",
            "Berlin",
        ],
    ),
];
...
pub fn memory_iter(scale: BeamScale, num_needles: usize) -> impl Iterator<Item = EvalMemory> {
