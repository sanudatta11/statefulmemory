...
//! Bulk ingestion of EvalMemory records into statefulmemory projects via the
        ...
        project
            ...
            .send(WriteRequest::SaveObservation {
                input: SaveObservationInput {
                    ...
                    created_by: Some("statefulmemory-eval".to_string()),
...
pub async fn ingest_stream<I>(data_dir: &Path, memories: I, batch_size: usize) -> Result<usize>
where
