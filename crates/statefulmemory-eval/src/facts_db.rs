...
//!   5. Run refinery migrations from `crates/statefulmemory-eval/migrations_eval/`.
//!
//! This is intentionally a **separate** migration root from the storage
//! daemon's `crates/statefulmemory-storage/migrations/` (SC-10 tripwire). refinery
...
mod migrations {
    refinery::embed_migrations!("../statefulmemory-eval/migrations_eval");
}
