...
//!
//! We bypass `statefulmemory_storage::read::search` because its sanitizer wraps the
...
const STOPWORDS: &[&str] = &[
    ...
    "to", "for", "with", "by", "from", "as", "and", "or", "but", "not", "do", "does", "did",
    "have", "has", "had", "what", "when", "where", "who", "whom", "why", "how", "which", "that",
    "this", "these", "those", "it", "its", "they", "them", "their", "i", "me", "my", "you", "your",
    "we", "us", "our", "would", "could", "should", "will", "shall", "may", "might", "can", "go",
...
pub fn retrieve(data_dir: &Path, project: &str, query: &str, k: i32) -> Result<RetrieveResult> {
