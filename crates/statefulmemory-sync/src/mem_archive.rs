//! statefulmemory `.mem` archive: SMEM + MessagePack + zstd-19.
...
const KEY_DOMAIN: &[u8] = b"statefulmemory.mem.v1\0";
...
mod tests {
    ...
    fn not_legible() {
        ...
        assert!(!as_str.contains("statefulmemory.archive"));
