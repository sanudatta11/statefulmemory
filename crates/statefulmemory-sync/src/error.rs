...
pub enum SyncError {
    ...
    Storage(#[from] statefulmemory_core::Error),

    #[error("task join error: {0}")]
    Join(String),

    #[error("not a statefulmemory archive (bad magic)")]
    NotArchive,

    #[error("unsupported statefulmemory archive version {0}")]
    UnsupportedVersion(u16),

    #[error("statefulmemory archive truncated")]
    Truncated,

    #[error("statefulmemory archive checksum mismatch")]
    ChecksumMismatch,
