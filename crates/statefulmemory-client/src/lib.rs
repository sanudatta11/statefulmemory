//! statefulmemory gRPC client utilities used by every CLI subcommand.
//!
//! Spec sections: FR2, §11.1.
//!
//! Two transports are supported:
//!
//! - **UDS** (`~/.statefulmemory/daemon.sock`): default for single-user mode. The
...
//!
//! Higher-level CLI command modules build a [`StatefulMemoryClient`] from the
...
pub use statefulmemory_proto::stateful_memory_client::StatefulMemoryClient;
