---
title: Web UI
description: Browse memory, trace the entity graph, and run Decide from a loopback dashboard — `statefulmemory ui`.
---

`statefulmemory ui` serves a lightweight single-page dashboard on your loopback
...
<video class="ml-demo-video" controls playsinline muted preload="metadata" src="/videos/ui-tour-v2.mp4" title="statefulmemory UI tour">
  Your browser does not support video.
</video>

```bash
statefulmemory ui
# statefulmemory UI → http://127.0.0.1:4687     hit Ctrl-C to stop
```
